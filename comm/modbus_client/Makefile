...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = modbus_client1.0.0
DISTDIR = /home/prointegra/repositorios/desarrollo/prointegra-OPC/comm/modbus_client/.tmp/modbus_client1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		modbus_client.pro  modbus_clientv2.cpp
...
modbus_clientv2.o: modbus_clientv2.cpp /opt/pvb/rllib/lib/rlmodbus.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modbus_clientv2.o modbus_clientv2.cpp
